...
type AuthenticationTicket struct {
	ClaimsPrincipal web.ClaimsPrincipal `json:"claimsPrincipal"`
...
func NewCookieAuthentication(options *Options) *CookieAuthentica {
...
// Scheme 认证方案名称
func (h *CookieAuthentica) AuthType() string {
	return "Cookie"
}

// Authenticate 从请求中认证 Cookie
func (a *CookieAuthentica) Authenticate(r *http.Request) (*web.ClaimsPrincipal, error) {
