...
// method 请求方法
// pattern 请求路径
func (a *Options) registerRoute(method, pattern string) {
	a.mu.Lock()
	defer a.mu.Unlock()
...
// dummyHandler 空处理函数
func (a *Options) dummyHandler(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
	// 空处理函数，仅用于路由匹配
}
...
func (a *Options) findMatchingRoute(method, path string) (router.RouteKey, bool) {
...
func (a *Options) getPoliciesForRequest(method, path string) []string {
